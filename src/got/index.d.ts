...
declare namespace got {
  type GotRes<T> = { body: { value: T } };
  interface GotFn {
    <T>(url: GotUrl): GotPromise<string>;
    <T>(url: GotUrl, options: GotJSONOptions): Promise<GotRes<T>>;
    <T>(url: GotUrl, options: GotFormOptions<string>): Promise<GotRes<T>>;
    <T>(url: GotUrl, options: GotFormOptions<null>): Promise<GotRes<T>>;
    <T>(url: GotUrl, options: GotBodyOptions<string>): Promise<GotRes<T>>;
    <T>(url: GotUrl, options: GotBodyOptions<null>): Promise<GotRes<T>>;
    <T>(url: GotUrl, options: GotJSONOptions): Promise<GotRes<T>>;
  }

  interface GotJSONFn {
    <T>(url: GotUrl): Promise<GotRes<T>>;
    <T>(url: GotUrl, options: Partial<GotJSONOptions>): Promise<GotRes<T>>;
  }
